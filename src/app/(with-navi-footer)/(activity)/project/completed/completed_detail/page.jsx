  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mt-8 rounded-lg border bg-white p-6 shadow-md">
        ...
        {/* 대표 이미지 */}
        <div className="mt-4 flex h-64 w-full items-center justify-center bg-gray-200 text-gray-500">
          대표 이미지 표시
        </div>
        ...
        <div className="mt-6">
          <p>
            <strong>프로젝트 기간:</strong> 20XX.XX.XX - 20XX.XX.XX
          </p>
          <p>
            <strong>프로젝트 유형:</strong>{' '}
            <span className="text-blue-600">해커톤</span>
          </p>
          <p>
            <strong>관련 분야:</strong>{' '}
          ...
          <p>
            <strong>참여 인원:</strong> FE: 000, BE: 000
          </p>
        </div>

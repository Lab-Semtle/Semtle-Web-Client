...
const RecruitmentPostViewPage = () => {
  ...
  return (
    <>
      <div className="mx-auto mt-20 mb-20 max-w-4xl rounded-lg bg-white p-6 shadow-md">
        ...
        <div className="mb-6">
          <label className="font-semibold text-gray-700">카테고리</label>
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-gray-800">{postData.content || '설명 없음'}</p>
        </div>

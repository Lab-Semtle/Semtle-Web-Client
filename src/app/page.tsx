...
import CardImageLabel from '@/components/CardImageLabel';
// pages/index.tsx
  ...
  return (
    <div>
      ...
      <div className="mt-20 flex flex-col items-center justify-center">
        <p className="text-xl font-bold">Arch Semtle</p>
        <div className="text-l mt-10 text-center font-bold">
          <p>
      ...
      <div className="mt-10 flex items-center justify-center">
        <div className="flex gap-4">
          <CardImageLabel
            ...
            contentText="매 학기 20여개에 이르는 다양한 분야의 세션과 스터디를 통해 서로 가르치고 배우며 여러 컴퓨터 분야에 대한 지식을 넓힐 수 있습니다."
          />
          <CardImageLabel
            imageSrc="2.jpg"
            altText="Example Image 2"
            contentText="우리는 다양한 대회와 프로젝트에 참여하여 기술적 역량을 키우고, 실제 문제를 해결하는 경험을 쌓고 있습니다."
          />
          <CardImageLabel
            imageSrc="3.jpg"
            altText="Example Image 3"
            contentText="컴퓨터라는 같은 관심사를 가진 사람들끼리 모여 소통하고, 친목조나 뒷풀이 등의 다양한 친목활동을 통해 화목한 동아리생활을 즐길 수 있습니다."
          />
          <CardImageLabel
            imageSrc="4.jpg"
            altText="Example Image 4"
            contentText="해커톤, 게임잼 등의 다양한 행사가 열리고 있으며, 팀을 꾸려 대회에 나가거나 프로젝트를 통해 결과물을 만들어내는 활동 또한 활발하게 이어지고 있습니다."
          />
        </div>
      </div>
